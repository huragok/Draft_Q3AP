...
\begin{figure}[!t]
    ...
    \begin{minipage}[b]{0.48\linewidth}
      ...
      \centerline{(b) Heuristic remapping in~\cite{seddik2008trans}}\medskip
    \end{minipage}
    \begin{minipage}[b]{0.48\linewidth}
      \centering
...
Finally, we test the robustness of the Q3AP CoRe solution. In practical

\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{./figs/mismatch.eps}
    \caption{.}
    \label{fig:mismatch}
\end{figure}
