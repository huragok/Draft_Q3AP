...
% Q3AP/QAP solution for HARQ model (need to rewrite this section since we used
...
% Mention how to do the partition.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{./figs/BERupperbound.eps}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{./figs/BERmontecarlo.eps}
